...
const Header = () => {
    return (
        <header className="bg-black text-white dark:bg-cyan-600/80 text-sm py-2 px-24 flex justify-between items-center">
            {/* Thong tin lien he */}
            <div className="flex w-full justify-center lg:w-3/4 flex-wrap max-md:grid max-md:grid-cols-2 gap-y-2 gap-4">
                ...
                <div className="flex gap-1 truncate">
                    <Mail />
                    <p className="hover:text-cyan-400 ">admin@FashBEAUT.com</p>
                </div>
                <div className="flex gap-1 truncate">
                    <Phone />
